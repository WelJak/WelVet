...
public class Endpoints {
    ...
    private static final String APPOINTMENT_PROPOSITION_ENDPOINT = APPOINTMENT_ENDPOINT + "/proposition";
    private static final String VET_APPOINTMENT_PROPOSITION_ENDPOINT = "/vet" + APPOINTMENT_PROPOSITION_ENDPOINT;
    private static final String OWNER_APPOINTMENT_PROPOSITION_ENDPOINT = "/owner" + APPOINTMENT_PROPOSITION_ENDPOINT;
    public static final String GET_APPOINTMENT_PROPOSITION_DETAILS_ENDPOINT = APPOINTMENT_PROPOSITION_ENDPOINT + "/{uuid}";
    public static final String VET_CREATE_APPOINTMENT_PROPOSITION_ENDPOINT = VET_APPOINTMENT_PROPOSITION_ENDPOINT + "/create";
    private static final String OWNER_CONFIRM_APPOINTMENT_PROPOSITION_ENDPOINT = OWNER_APPOINTMENT_PROPOSITION_ENDPOINT +"/confirm";
    public static final String OWNER_CONFIRM_APPOINTMENT_PROPOSITIONS_ENDPOINT = OWNER_CONFIRM_APPOINTMENT_PROPOSITION_ENDPOINT + "/{uuid}";
